...
2.  **Medicare Costs:** Update Part B premiums + average Part D + Medigap estimates.
3.  **State Multipliers:** Review if certain states have significantly diverged in healthcare costs relative to the national average.

## State Tax Data (`src/data/state_tax_config.json`)

**Source:** State Department of Revenue websites, Tax Foundation "State Individual Income Tax Rates and Brackets".
